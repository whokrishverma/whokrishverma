#!/usr/bin/env python3
"""Generate an animated GitHub contribution-heatmap SVG (squares pop in and
briefly flash brighter, diagonal sweep top-left -> bottom-right, once then
freezes). Pulls real contribution data from a public, unauthenticated API --
no GitHub token needed.

Usage: python generate_streak_svg.py [username] [output.svg]
Designed to run daily via GitHub Actions to stay live.
"""
import sys, json, os, datetime, urllib.request

USER = sys.argv[1] if len(sys.argv) > 1 else "whokrishverma"
